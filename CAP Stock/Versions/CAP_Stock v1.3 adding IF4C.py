...
if4c_excel_path = os.path.join(home_directory, r'OneDrive - Motor Depot\Pricing\Input Files\IF4C.xlsx')
input_excel_pattern = os.path.join(home_directory, r'OneDrive - Motor Depot\Pricing\Input Files\vehicles-autoedit*.xlsx')
location_history_pattern = os.path.join(home_directory, r'OneDrive - Motor Depot\Pricing\Input Files\vehicles-location-history*.csv')
