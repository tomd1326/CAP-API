...
async def process_row(row, session):
    ...
    valuation_info = await fetch_valuation(payload, row.Registration, session)
    ...
    return [row.Registration, payload['mileage'], capid, reg_date, clean, retail, valuation_date, rounded_mileage_10000,
